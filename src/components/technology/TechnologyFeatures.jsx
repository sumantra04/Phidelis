...
const TechnologyFeatures = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] py-[100px] px-[81px] mx-auto">
        <h2 className="tech-header text-white text-[50px] font-semibold leading-[1.2] mb-[40px]">
          Technology Powers Clarity and Control
        </h2>

        <div className="tech-container flex gap-[50px] items-center md:flex-row flex-col">
          {/* IMAGE */}
          <div className="tech-card w-[444px] h-[531px] lg:min-h-[531px] rounded-[8px] overflow-hidden flex-shrink-0">
            <img
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[34px] content-start">
            {techFeatures.map((feature, idx) => (
              <div
                key={idx}
                className="tech-card w-full max-w-[383px] min-w-[200px] mx-auto"
              >
